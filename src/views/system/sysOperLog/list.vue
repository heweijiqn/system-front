<template>
  <div class="oper-log-page">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="模块标题">
              <el-input v-model="searchObj.title" placeholder="模块标题"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="操作人员">
              <el-input v-model="searchObj.operName" placeholder="操作人员"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    >
      ...
      <el-table-column prop="operIp" label="操作IP地址"></el-table-column>
      <el-table-column prop="requestMethod" label="请求方式"></el-table-column>
      <el-table-column prop="operUrl" label="请求URL"></el-table-column>
      <el-table-column prop="operParam" label="请求参数"></el-table-column>
      <el-table-column prop="jsonResult" label="返回参数"></el-table-column>
      ...
      <el-table-column prop="errorMsg" label="错误消息"></el-table-column>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      api.getLoginLogList(this.pagination.page, this.pagination.limit, this.searchObj)
        .then(response => {
    ...
    batchDeleteData() {
      ...
      .then(() => {
        api.batchDeleteLoginLogs(idList)
          .then(() => {
